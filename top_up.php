        ...
        <div class="container">
            <div class="anime__details__content">
                    <?php
                                    ...
                                    FROM game sp
                                    LEFT JOIN spesifikasi USING(id_game) where id_game = '$id'";
                            $b = $koneksi->query($a);
                        ...
                        <div class="anime__details__text">
                            ...
                            <?php
                                    ...
                                    ?>
                                        ...
                                        <ul>
                                        <?php
                                                $produk ="SELECT * from produk_game  WHERE id_top_up = '$f[id_top_up]'";
                                                $i = $koneksi->query($produk);
                                                while ($j=$i->fetch_array()) {
                                        ?>
                                        <a href="detil_bayar.php?id_produk=<?=$j['id_produk']?>" class="watch-btn"><span><?php echo $h['jenis_top_up'] ?> </span><i
                                        <?php } ?>
