                        ...
                        <div class="col-lg-12">
                            <div class="blog__item set-bg" >
                                <div class="blog__item__text">
                                    ...
                                    <a href="crud_game.php" class="watch-btn"><span>CRUD Game</span> <i
                            ...
                            <div class="blog__item set-bg" >
                                <div class="blog__item__text">
                                    <div class="anime__details__btn">
                                    <a href="crud_produk.php" class="watch-btn"><span>CRUD Produk</span> <i
                                    class="fa fa-angle-right"></i></a>
                            ...
                            <div class="blog__item set-bg" >
                                <div class="blog__item__text">
                                    <div class="anime__details__btn">
                                    <a href="crud_produk_lain.php" class="watch-btn"><span>CRUD Produk</span> <i
                                    class="fa fa-angle-right"></i></a>
