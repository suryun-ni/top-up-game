...
<body>
   ...
   <header class="header">
    ...
    $harga = $h['harga_top_up'];
    $tanggal = date("Y-m-d H:i:s");
   
   
   $detil = "SELECT * FROM detil_bayar WHERE id_produk = '$id_produk'";
    ...
    if (isset($_POST['submit'])) {
        ...
        (id_user, metode_bayar, total_bayar, tanggal, id_detil_bayar) 
        VALUES ('" . $id_user . "','" . $metode_bayar . "','" . $harga . "','" . $tanggal ."','" . $y['id_detil_bayar'] ."') ";
