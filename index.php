    ...
    <section class="hero">
        <div class="container">
            <div class="hero__slider owl-carousel">
                ...
                <div class="hero__items set-bg" data-setbg="img/hero/pubgm.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                
                                <h2>Jangan Ketinggalan Beli Battle Pass terbaru PUBGM</h2>
                                <p>apakah anda siap mendapat chiken dinner?</p>
                               
                            </div>
                        </div>
                    </div>
                </div>
                <div class="hero__items set-bg" data-setbg="img/hero/summer.jpg">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                
                                <h2>Summer Event <br> Telah Tiba!</h2>
                                <p>Summer event tiba dan banyak event baru ada</p>
                               
                            </div>
                        </div>
                    </div>
                </div>
                <div class="hero__items set-bg" data-setbg="img/hero/banner1.png">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                
                                <h2>Banner Baru Dengan Character Baru</h2>
                                <p>siapkah kamu untuk meroll dia?</p>
                    ...
                    <div class="trending__product">
                        ...
                        <div class="row">
                                    ...
                                    $a = "SELECT sp.id_game,file, nama_game,detail, platform, spesifikasi     
                                            FROM game sp
                                            LEFT JOIN spesifikasi USING(id_game)";
                                    $b = $koneksi->query($a);
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="<?php echo "img/file/".$c['file'] ?>">
                                        <div class="ep"><?php echo $c['platform'] ?>
                                        </div>
