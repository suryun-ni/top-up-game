                ...
                <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            <div class="blog__item set-bg" >
                                ...
                                <h4><a href="#">Rate Our Blog</a></h4>
                                <form action="aksi_rate.php"  method="POST">
                                    <div class="rate">
                                ...
                                <textarea name="pesan"  cols="35" rows="5" placeholder="masukkan pesan dan kesan disini"></textarea>
                                     
                                     <button type="submit" name="rate" value="rate" class="site-btn">Submit</button>
